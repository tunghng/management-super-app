...
public class FormCode {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "form_code_seq")
    @GenericGenerator(name = "form_code_seq", strategy = "com.im.form.model.generator.CodeGenerator", parameters = {
