...
import com.im.billing.dto.response.page.SortOrder;
import com.im.billing.exception.ForbiddenException;
...
public abstract class BaseController {
    ...
    void checkBillType(String type, AppUserDto currentUser) {
        BillTypeDto billTypeDto = billTypeService.findByNameAndTenantId(type, currentUser);
        checkNotNull(billTypeDto, String.format("Type with name [%s] is not found", type));
    }
